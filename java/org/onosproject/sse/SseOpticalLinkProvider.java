...
public class SseOpticalLinkProvider extends AbstractProvider implements LinkProvider {

    private static final Logger log = LoggerFactory.getLogger(SseOpticalLinkProvider.class);
    ...
    public SseOpticalLinkProvider() {
        super(new ProviderId("optical", "org.onosproject.sse"));
    }
